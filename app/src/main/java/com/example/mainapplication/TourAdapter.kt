...
//                if (holder.itemView.likeIm.drawable.constantState!! == ContextCompat.getDrawable(
//                        context,
//                        R.drawable.save_like
//                    )!!.constantState
//                ) {
//                    ContextCompat.getDrawable(context, R.drawable.like)?.let {
//                        holder.itemView.likeIm.setImageDrawable(it)
...
//
//                    }
//                    //Log.d("TourAdapter", mAuth.currentUser?.uid)

//                }

                // holder.itemView.likeIm.setImageResource(ContextCompat.getDrawable(context,R.drawable.like))
            }
        }
    }
